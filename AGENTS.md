# Validation Repository Agent Contract
...
cannot accept its own promotion or broaden its own capability. A distinct
reviewer is dispatched only when a receipt or stable-subject gate requires one.
